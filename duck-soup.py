...
from elements.ai_agent import NLP_opeanai
from elements.graph_building import GraphPanel

from elements.huggingface_model import HuggingFace_Model
...
if __name__ == '__main__':
    app = wx.App()
    Duck_Soup(None, title='duck-soup')
    app.MainLoop()
